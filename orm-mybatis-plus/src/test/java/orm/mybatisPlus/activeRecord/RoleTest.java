package orm.mybatisPlus.activeRecord;
...
import orm.mybatisPlus.OrmMybatisPlusApplicationTest;
import orm.mybatisPlus.entity.Role;
...
@Slf4j
public class RoleTest extends OrmMybatisPlusApplicationTest {
    /**
